...
public class SongListAdapter extends RecyclerView.Adapter<SongListAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            art = view.findViewById(R.id.img_2);
            title = view.findViewById(R.id.title_2);
            artist = view.findViewById(R.id.url_2);
        }
    }
...
//            }).getSongFromCloud();
    ...
    public void setPlaylists(List<Track> playList) {
        this.tracks = playList;
    }


    public SongListAdapter(Context ctx, List<Track> tracks) {
        super();
        context = ctx;
        this.tracks = tracks;
    }

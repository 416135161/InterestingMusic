package com.old.interesting.music.fragments.AboutFragment;
...
public class AboutFragment extends Fragment {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        if (HomeActivity.isReloaded) {
            ...
            bottomMarginLayout.getLayoutParams().height = com.old.interesting.music.utilities.CommonUtils.dpTopx(65, getContext());
        }
...
//                startActivity(sendIntent);
    ...
    public void displayOpenSourceLicenses(){
        ...
        alertDialog.setTitle("Free Music Box");

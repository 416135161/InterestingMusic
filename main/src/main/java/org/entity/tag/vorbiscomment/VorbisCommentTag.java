 ...
 */
package org.entity.tag.vorbiscomment;

import org.entity.audio.flac.metadatablock.MetadataBlockDataPicture;
import org.entity.audio.generic.AbstractTag;
import org.entity.audio.generic.Utils;
import org.entity.audio.ogg.util.VorbisHeader;
import org.entity.logging.ErrorMessage;
import org.entity.tag.*;
import org.entity.tag.images.Artwork;

import static org.entity.tag.vorbiscomment.VorbisCommentFieldKey.VENDOR;

import org.entity.tag.id3.valuepair.TextEncoding;
import org.entity.tag.images.ArtworkFactory;
import org.entity.tag.vorbiscomment.util.Base64Coder;
...
public class VorbisCommentTag extends AbstractTag
{
     ...
     * @param value
     * @return
     * @throws org.entity.tag.KeyNotFoundException
     * @throws org.entity.tag.FieldDataInvalidException
     */

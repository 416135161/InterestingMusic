 ...
 *
 */
package org.entity.tag;

import org.entity.tag.id3.framebody.AbstractID3v2FrameBody;
import org.entity.tag.id3.framebody.FrameBodyCOMM;
import org.entity.tag.id3.framebody.FrameBodyTIPL;
import org.entity.tag.id3.framebody.ID3v24FrameBody;
import org.entity.tag.id3.valuepair.TextEncoding;
import org.entity.tag.lyrics3.Lyrics3v2Fields;
import org.entity.tag.options.PadNumberOption;
import org.entity.tag.reference.GenreTypes;
import org.entity.tag.reference.ID3V2Version;

 ...
 */
package org.entity.audio.asf;

import org.entity.audio.AudioFile;
import org.entity.audio.asf.data.AsfHeader;
import org.entity.audio.asf.data.AudioStreamChunk;
import org.entity.audio.asf.data.MetadataContainer;
import org.entity.audio.asf.data.MetadataDescriptor;
import org.entity.audio.asf.io.*;
import org.entity.tag.asf.AsfTag;
import org.entity.audio.asf.util.TagConverter;
import org.entity.audio.asf.util.Utils;
...
public class AsfFileReader extends AudioFileReader {
     ...
     * (overridden)
     * 
     * @see org.entity.audio.generic.AudioFileReader#getEncodingInfo(java.io.RandomAccessFile)
     */
    @Override
     ...
     * (overridden)
     * 
     * @see org.entity.audio.generic.AudioFileReader#getTag(java.io.RandomAccessFile)
     */
    @Override

package com.happy.interesting.music.fragments.AboutFragment;
...
public class AboutFragment extends Fragment {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        if (HomeActivity.isReloaded) {
            ...
            bottomMarginLayout.getLayoutParams().height = com.happy.interesting.music.utilities.CommonUtils.dpTopx(65, getContext());
        }
    ...
    public void displayOpenSourceLicenses(){
        ...
        alertDialog.setTitle("Music Lark");

 ...
 */
package org.entity.tag.datatype;

import org.entity.tag.InvalidDataTypeException;
import org.entity.tag.id3.AbstractTagFrameBody;
import org.entity.tag.id3.valuepair.EventTimingTypes;

/**
 * A single synchronized tempo code. Part of a list of temnpo codes ({@link org.entity.tag.datatype.SynchronisedTempoCodeList}), that are contained in
 * {@link org.entity.tag.id3.framebody.FrameBodySYTC}
 *
